...
const ContactModal = () => {
    ...
    const onSubmit = (data) => {
        ...
        // In a real production scenario, this would be handled by a backend service.
        // For now, we simulate the submission and confirm the target email.
            ...
            {isContactModalOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 m-auto w-[92%] md:w-full max-w-4xl h-fit max-h-[90vh] overflow-y-auto bg-navy border border-cyan/20 z-[210] rounded-xl shadow-[0_0_100px_rgba(0,242,234,0.15)] p-6 md:p-12"
                    >
                        <button
                            onClick={closeContactModal}
                            className="absolute top-6 right-6 text-sand/40 hover:text-cyan transition-colors p-2"
                        >
                            <X size={24} />
                        </button>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                            <div>
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-cyan uppercase tracking-[0.3em] text-[10px] font-bold block">Direct Expert Access</span>
                                </div>
                                <h2 className="text-4xl md:text-5xl font-display text-sand mb-6 leading-tight">LET'S BUILD YOUR <span className="text-cyan italic">VISION.</span></h2>
                                ...
                                <div className="space-y-6 pt-8 border-t border-cyan/10">
                                    <div className="group flex items-center gap-4 text-xs text-sand/60 font-bold uppercase tracking-widest cursor-pointer hover:text-cyan transition-colors">
                                        <div className="p-3 bg-cyan/10 rounded-full group-hover:bg-cyan group-hover:text-navy transition-all">
                                            <Phone size={18} />
                                        </div>
                            ...
                            <div className="relative">
                                <div className="absolute -inset-2 bg-gradient-to-br from-cyan/20 to-transparent blur-2xl -z-10 opacity-30" />
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-deep/30 p-8 rounded-xl border border-cyan/5">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-cyan hover:bg-white text-navy font-black py-6 flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-[10px] transition-all shadow-[0_0_30px_rgba(0,242,234,0.2)]"
                                    >
